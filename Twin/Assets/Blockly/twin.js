...
Twin.analogRead = function(data) {
  ...
  return ['TwinHelper.getMessage(\'' + message + '\', \'1\')', Blockly.JavaScript.ORDER_NONE];
}
...
Twin.analogWrite = function(data) {
  ...
  return 'TwinHelper.sendMessage(\'' + message + '\');\n';
}
...
Twin.digitalRead = function(data) {
  ...
  return ['TwinHelper.getMessage(\'' + message + '\', \'0\')', Blockly.JavaScript.ORDER_NONE];
}
...
Twin.sleep = function(duration) {
  ...
  return 'TwinHelper.sleep(\'' + duration + '\');\n';
}
...
// Blockly.JavaScript.INFINITE_LOOP_TRAP = 'if(--TwinHelper.infiniteLoopTrap == 0) { TwinHelper.stopInfiniteLoop(); }\n';
